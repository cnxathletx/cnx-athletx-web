...
- AthletX Points loyalty balances for paid purchases, with optional checkout redemption capped at 5% and mutually exclusive with discount codes
...
| Stage | Scope | Status |
|-------|-------|--------|
| **Current build** | Core storefront, checkout, manual payment workflow, payment proof, accounts, AthletX Points, admin dashboard, discounts, settings, chat, reporting, analytics, and email flows | Implemented in repo, not released |
