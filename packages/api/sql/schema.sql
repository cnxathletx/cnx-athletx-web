...
-- product_waitlist_signups table (SKU-specific back-in-stock requests)
...
CREATE INDEX IF NOT EXISTS idx_product_waitlist_product_status ON product_waitlist_signups(product_id, notified_at);
CREATE INDEX IF NOT EXISTS idx_product_waitlist_email ON product_waitlist_signups(email);
