...
const DROP_TABLES = ['email_logs','admin_audit_log','shipments','payment_proofs','payments','order_items','orders','sessions','magic_links','users','discount_codes','inventory','products','site_settings']
