...
const DROP_TABLES = ['product_line_lab_tests','reviews','email_logs','admin_audit_log','shipments','payment_proofs','payments','order_items','orders','sessions','magic_links','users','discount_codes','inventory','price_tiers','product_images','products','product_lines','site_settings']
